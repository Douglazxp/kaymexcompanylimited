            ...
            <div className="space-y-6">
              <div className="flex items-start md:items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <a href="mailto:kaymexcompanylimited@gmail.com" className="text-xs md:text-lg hover:text-primary transition-colors block break-all">kaymexcompanylimited@gmail.com</a>
                </div>
              </div>
              <div className="flex items-start md:items-center gap-4">
